...
public class DongSPController {
    ...
    @GetMapping("delete")
    public String deleteDongSP(Model model, @RequestParam("id") String id, RedirectAttributes redirAttrs) {
        try {
    ...
    @PostMapping("store")
    public String storeDongSP(Model model, @Valid @ModelAttribute("dongsp") DongSP dongsp1,
    ...
    @PostMapping("update")
    public String update(@Valid @ModelAttribute("dongsp") DongSP dongsp1, BindingResult theBindingResult, Model model,
            @RequestParam("imageFile") MultipartFile file) {
        if (theBindingResult.hasErrors()) {
            return "manager/dongsanpham/update.html";
        }
